...
class _AddStockViewState extends State<AddStockView> {
  ...
  void _submit() {
    ...
    final product = ProductHiveModel(
      ...
      unit: _unit, // ← Use _unit instead of _unitCtrl.text
  ...
  // Normalize unit value to match dropdown items (case-insensitive)
  String _normalizeUnit(String unit) {
    final validUnits = ['Units', 'Pcs', 'Box', 'Kg', 'Liter'];
    for (var validUnit in validUnits) {
      ...
      children: [
        ...
        Expanded(
          child: DropdownButtonFormField<String>(
            ...
            onChanged: (v) => setState(() => _unit = v!), // ← Update _unit
          ),
        ),
      ],
    );
